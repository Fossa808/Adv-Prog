...
public class HangmanMain  {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        // set up the EvilHangman and start the game
        List<String> dictionary2 = Collections.unmodifiableList(dictionary);
        EvilHangman hangman = new EvilHangman(dictionary2, length, max);
    ...
    public static void playGame(Scanner console, EvilHangman hangman) {
    ...
    public static void showResults(EvilHangman hangman) {
